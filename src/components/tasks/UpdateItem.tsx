...
import type { TaskUpdate, TaskReply } from "@/lib/tasksApi";
import { supabase } from "@/integrations/supabase/client"; // For getting current user

interface UpdateItemProps {
  update: TaskUpdate & { replies: TaskReply[] };
  onReply: (updateId: string, body: string, author: string) => Promise<TaskReply | null>;
}
...
export function UpdateItem({ update, onReply }: UpdateItemProps) {
